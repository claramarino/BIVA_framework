...
##### Raw data --- too heavy for github => use derived data #####
...
sr_all <- readRDS("Data/derived-data/06_DD_species_richness_110_km.rds")
...
saveRDS(compl, "data/data-for-analyses/14_Completeness_Sensitivity_110_km.rds")
